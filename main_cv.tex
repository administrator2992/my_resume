...
\begin{document}
    ...
    \begin{tabular}{@{}p{0.15\textwidth}p{0.85\textwidth}}
        ...
        & Conducting research on object detection (YOLOv4) to detect masked face/wrong masked face/no masked face on edge devices. \textbf{GOAL: classifying masked face/wrong masked face/no masked face accurately on edge devices} \\
